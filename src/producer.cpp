...
#define NAN_GET_CPRODUCER()                                                               \
    ...
    void RocketMQProducer::SetOptions(Local<Object> options)
    {
        ...
        {
            file_num = Nan::To<int32_t>(_log_file_num_v).FromJust();
        }
        if (_log_file_size_v->IsNumber())
        {
            file_size = Nan::To<int32_t>(_log_file_size_v).FromJust();
        }
        ...
        {
            int level = Nan::To<int32_t>(_log_level_v).FromJust();
        ...
        {
            int level = Nan::To<int32_t>(_compress_level_v).FromJust();
        ...
        {
            int timeout = Nan::To<int32_t>(_send_message_timeout_v).FromJust();
        ...
        {
            int size = Nan::To<int32_t>(_max_message_size_v).FromJust();
    ...
    NAN_MODULE_INIT(RocketMQProducer::Init)
    {
        ...
        Nan::Set(target, Nan::New("Producer").ToLocalChecked(), Nan::GetFunction(tpl).ToLocalChecked());
    }
    ...
    NAN_METHOD(RocketMQProducer::Start)
    {
        ...
        Nan::Callback *callback = (info[0]->IsFunction()) ? new Nan::Callback(Nan::To<Function>(info[0]).ToLocalChecked()) : NULL;
    ...
    NAN_METHOD(RocketMQProducer::Send)
    {
        ...
        Nan::Callback *callback = (info[3]->IsFunction()) ? new Nan::Callback(Nan::To<Function>(info[3]).ToLocalChecked()) : NULL;
