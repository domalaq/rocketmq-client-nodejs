...
#define NAN_GET_CPUSHCONSUMER()                                                                   \
    ...
    RocketMQPushConsumer::RocketMQPushConsumer(const char *group_id, const char *instance_name) : consumer_ptr(NULL)
    {
    ...
    NAN_MODULE_INIT(RocketMQPushConsumer::Init)
    {
        ...
        Nan::Set(target, Nan::New("PushConsumer").ToLocalChecked(), Nan::GetFunction(tpl).ToLocalChecked());
    }
